...
function preload() {
  ...
  game.load.image('infoWin','game_starter2/assets/info_window.png');
}
...
function create() {
  ...
  info_win = (game.add.sprite(game.world.centerX,game.world.centerY,'infoWin',0));
  go_text = (game.add.text(game.world.centerX, game.world.centerY, "you win", {font: "36px Arial", fill: "#ff9900", align: "left"}));
  go_text.setShadow(-3,3,'rgba(153,0,0,0.5)',0.5);go_text.anchor.x=0.5;
  go_text.anchor.y=0.5;
  go_text.visible=false;
  info_win.anchor.x=0.5;
  info_win.anchor.y=0.5;
...
function update() {
  ...
  game.physics.arcade.collide(layer,d,null,null,this);
  game.physics.arcade.collide(p2,d,endgame,null,this);
  p2.body.velocity.x=0;
  p2.body.velocity.y=0;
  if ((game.physics.arcade.distanceBetween(p2,d)) < 300) {
    game.physics.arcade.moveToObject(d,p2,75);
  }
